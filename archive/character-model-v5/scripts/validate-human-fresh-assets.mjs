...
if (manifest.model !== 'adventurer-fresh-v5' || manifest.version !== 5) {
  throw new Error(`Expected adventurer-fresh-v5, got ${manifest.model} v${manifest.version}.`);
}
...
console.log('Validated 153 from-scratch human adventurer-fresh-v5 atlases: chunky shared-rig head construction, restrained profile silhouettes, sparse directional faces, race-owned heritage layers, anchored equipment, four-phase walks and attacks, eight directions, one-sword DPS weapons, and independent tank offhands.');
