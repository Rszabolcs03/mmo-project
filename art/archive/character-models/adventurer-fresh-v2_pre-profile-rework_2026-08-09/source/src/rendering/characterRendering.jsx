...
function drawCharacterLayeredSprite(context, player, selectedClass, selectedRace, appearance = {}) {
  ...
  const usesRegisteredHuman = usesCurrentHuman
    && CHARACTER_SPRITE_VERSION === 'adventurer-fresh-v2';
  ...
  const layerOrder = usesRegisteredHuman
    ? backFacing
      ? ['weapon', 'offhand', 'base', 'outfit', 'cape', 'face', 'beard', 'hair']
      : selectedClass === 'hunter'
        ? ['cape', 'base', 'outfit', 'weapon', 'face', 'beard', 'hair']
        : ['cape', 'base', 'outfit', 'face', 'beard', 'hair', 'offhand', 'weapon']
    : usesCurrentHuman
    ? backFacing
      ? ['weapon', 'base', 'outfit', 'cape', 'hair', 'face', 'beard', 'headwear']
      : ['cape', 'base', 'outfit', 'hair', 'face', 'beard', 'headwear', 'weapon']
    : usesHumanComposite
    ? backFacing
      ? ['cape', 'weapon', 'hair', 'outfit', 'face', 'beard']
      : ['cape', 'hair', 'outfit', 'face', 'beard', 'weapon']
...
function getCharacterLayerReplacements(layer, layerId, selectedClass, selectedRace, appearance) {
  ...
  if (layer === 'headwear') {
    const hat = appearance.hat ?? appearance.robe ?? '#315fc4';
    add('#202a68', shiftHexColor(hat, 0.46));
    add('#315fc4', hat);
    add('#4263eb', shiftHexColor(hat, 1.14));
  ...
  if (layer === 'outfit') {
    ...
    let robe = appearance.robe ?? sourcePalette?.robe;
...
const CHARACTER_PREVIEW_ROTATION = ['front', 'right', 'back', 'left'];
