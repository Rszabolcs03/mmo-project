...
function layerPaths(classId, body, options = {}) {
  ...
  return options.back
    ? [selected.weapon, selected.offhand, selected.body, selected.outfit, selected.cape, selected.face, selected.beard, selected.hair]
    : classId === 'hunter'
      ? [selected.cape, selected.body, selected.outfit, selected.weapon, selected.face, selected.beard, selected.hair]
      : [selected.cape, selected.body, selected.outfit, selected.face, selected.beard, selected.hair, selected.offhand, selected.weapon];
}
