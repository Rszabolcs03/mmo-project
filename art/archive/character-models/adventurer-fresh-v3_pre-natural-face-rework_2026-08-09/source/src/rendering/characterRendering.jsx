...
function drawCharacterLayeredSprite(context, player, selectedClass, selectedRace, appearance = {}) {
  ...
  const usesRegisteredHuman = usesCurrentHuman
    && CHARACTER_SPRITE_VERSION === 'adventurer-fresh-v3';
  ...
  const layerOrder = usesRegisteredHuman
    ? backFacing
      ? ['weapon', 'offhand', 'base', 'outfit', 'cape', 'face', 'heritage', 'beard', 'hair']
      : selectedClass === 'hunter'
        ? ['cape', 'base', 'outfit', 'weapon', 'face', 'heritage', 'beard', 'hair']
        : ['cape', 'base', 'outfit', 'face', 'heritage', 'beard', 'hair', 'offhand', 'weapon']
    : usesCurrentHuman
    ? backFacing
