...
const chunksDir = path.join(mapsDir, 'world_v2_chunks');
...
const VERSION = 'v2-runtime-chunks-1';
...
async function loadRegion(regionX, regionY) {
  const mapId = `world_region_${regionX}_${regionY}_v2`;
...
async function main() {
  ...
  await writeJson(path.join(chunksDir, 'world_v2_chunks.json'), {
    version: VERSION,
    tileSize: TILE_SIZE,
