...
function layerPaths(classId, body, options = {}) {
  ...
  const selected = {
    ...
    headwear: group.headwear[options.outfit ?? 'classic'],
    offhand: options.tank ? group.offhands[options.weapon ?? 'classic'] : null,
    weapon: group.weapons[options.weapon ?? 'classic'],
  };
  return options.back
    ? [selected.weapon, selected.offhand, selected.body, selected.outfit, selected.cape, selected.face, selected.heritage, selected.beard, selected.hair, selected.headwear]
    : classId === 'hunter'
      ? [selected.cape, selected.body, selected.outfit, selected.weapon, selected.face, selected.heritage, selected.beard, selected.hair, selected.headwear]
      : [selected.cape, selected.body, selected.outfit, selected.face, selected.heritage, selected.beard, selected.hair, selected.headwear, selected.offhand, selected.weapon];
}
